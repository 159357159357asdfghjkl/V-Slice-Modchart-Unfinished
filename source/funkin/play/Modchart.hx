...
class Modchart
{
  ...
  var radius:Float = FlxAngle.TO_RAD;
  ...
  inline function fastTan(x:Float):Float
  ...
  public function initMods()
  {
    ...
    var mods:Array<String> = [
      ...
      'bounce', 'bounceoffset', 'bounceperiod', 'bouncez', 'bouncezoffset', 'bouncezperiod', 'xmode', 'tiny'
    ];

    // don't write true or false, just write a number not equals to 0
    var boolmods:Array<String> = ['cosecant', 'dizzyholds', 'stealthtype', 'stealthpastreceptors'];
    for (i in 0...4)
    {
      mods.push('reverse$i');
      mods.push('movex$i');
