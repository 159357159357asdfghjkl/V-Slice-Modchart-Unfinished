...
// make the sprites have both skew and rotation
class ModchartSprite extends FlxSprite
{
  ...
  public var rotation(default, null):FlxPoint = FlxPoint.get();
...
class FunkinModchartSprite extends funkin.graphics.FunkinSprite
{
  /**
   * @author Zaphod
   */
